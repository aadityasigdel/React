            ...
            <div className="full m-5">
                {currentfortravels.map((travel) => (
                    <div className="flex flex-row h-1/4 justify-center items-center m-4 shadow-gray-500 shadow-md"  key={travel.id} >
                        ...
                        <div className="w-1/2 h-70 p-5 font-semibold">
                            <h1 className="text-2xl font-bold m-2">
                                {travel.name}
                            </h1>
                            <p className="m-1 ">price :${travel.price}</p>
                            <p className="m-1">rating : {travel.rating}</p>
                            <Link to={`/hotels/${travel.id}`}>
                            <button className="text-black bg-blue-500 text-md p-2 px-4 pr rounded-md m-1">
                                View
                            </button>
                            </Link>
